(function($) {
    ...
    var KAB_Setup_Wizard = {
        ...
        bindEvents: function() {
            ...
            // Add service button
            $(document).on('click', '#kab-add-service', function(e) {
                e.preventDefault();
                self.addServiceItem();
            });
            
            // Remove service button
            $(document).on('click', '.kab-remove-service', function(e) {
                e.preventDefault();
                self.removeServiceItem($(this));
            });
            
            // Form validation
            $(document).on('submit', '.kab-setup-form', function(e) {
        ...
        updateServiceNumbers: function() {
            $('#kab-services-container .kab-service-item').each(function(index) {
        ...
        validateServicesStep: function(form) {
            ...
            $('input[name^="services["][name$="][name]"]').each(function() {
